...
// print_r(Helper::getAllProductFromCart());
// exit();
?>
...
?>
                <tr>
                  ...
                  @endphp
                  <td class="col-md-6">
                    <img src="{{url('../lenorejackson/storage/app/'.$photo[0])}}" class="img-responsive pull-left" alt="cartImg">
                    <span>
                      <h6>Unit price</h6>
     ...
     <td class="float-right" colspan="5">
                ...
                <button class="webBtn" type="submit">Update</button>
                @else
      ...
      <div class="col-md-4 col-sm-4 col-xs-12">
        <div class="cartTotal">
          <ul>
            ...
            <li class="pull-right">{{$totalProducts}}</li>
            ...
            <li class="pull-right">
              <h5>${{number_format(Helper::totalCartPrice(),2)}}</h5>
            </li>
            <div class="clearfix"></div>
          </ul>
        </div>
